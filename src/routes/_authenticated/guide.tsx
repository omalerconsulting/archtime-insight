    ...
    <div className="mx-auto max-w-3xl space-y-8">
      <header>
        ...
        <p className="text-sm text-muted-foreground">
          {isAdmin
            ? "מדריך למשתמש בעל הרשאת מנהל/ת"
            : "מדריך לעובד/ת – דיווח שעות, היעדרויות ודוח חודשי"}
        </p>
      </header>
      ...
      <Section title="לעובד/ת">
        <Step n={1} title="החתמת כניסה ויציאה">
          בעמוד «דיווח שעות» לוחצים «כניסה» בתחילת היום ו«יציאה» בסופו. אפשר גם להזין שעות ידנית בשדות
          «הזנה ידנית» שבראש העמוד, או דרך «עריכה» בשורת התאריך – כולל דיווח רטרואקטיבי לימים קודמים.
        </Step>
        ...
        <Step n={6} title="פרטיות">
          המידע האישי שלך – שעות, היעדרויות ושכר – חשוף אליך בלבד. עמודי הניהול אינם זמינים לעובדים.
        </Step>
      </Section>
      )}
      ...
      {isAdmin && (
        <Section title="למנהל/ת">
          <Step n={1} title="הקמת פרויקט">
            בעמוד «פרויקטים» מוסיפים פרויקט עם קוד המשרד, שם, לקוח, שכר טרחה, תקציב שעות (לא חובה),
            תאריך התחלה וסטטוס (פעיל / בהצעת מחיר / הסתיים). בתוך אותו חלון מגדירים גם את תנאי התשלום.
          </Step>
          <Step n={2} title="תנאי תשלום ולו״ז">
            כל תחנה מוגדרת באחוזים או בסכום קבוע (למשל 30% עם חתימת חוזה), עם תאריך צפי לתשלום.
            סך התחנות חייב להשלים ל‑100% או לסכום שכר הטרחה – אחרת לא ניתן לשמור. חריגה מתאריך הצפי
            תסמן את הפרויקט באדום ותציג את מספר ימי החריגה.
          </Step>
          <Step n={3} title="דשבורד ניהולי וגרפים">
            «דשבורד» מציג שעות מצטברות לכל פרויקט, עלות שעות העבודה, רווח ושיעור רווח, תעריף אפקטיבי
            לשעה, מדדי יעילות עובדים, וגרפים ויזואליים לזיהוי מהיר של מצב המשרד.
          </Step>
          <Step n={4} title="גבייה וצפי הכנסות">
            «גבייה וכספים» מרכז את כל התחנות שטרם שולמו – כמה כסף עדיין בחוץ, אילו תשלומים באיחור,
            ודוח צפי הכנסות חודשי לפי תאריכי הצפי שהוזנו. ניתן להדפיס לישיבת הנהלה.
          </Step>
          <Step n={5} title="עובדים והרשאות">
            ב«עובדים» מוסיפים משתמשים חדשים (שם, דוא״ל וסיסמה ראשונית), קובעים למי יש הרשאת מנהל,
            מגדירים תעריף עלות לשעה לכל עובד (בסיס לחישוב הרווחיות) ומשביתים עובדים שסיימו.
          </Step>
          <Step n={6} title="דוחות לרואה החשבון">
            בעמוד «דוח חודשי» ניתן לבחור כל עובד בנפרד, להדפיס או לשמור PDF ולשלוח לרואה החשבון.
          </Step>
          <Step n={7} title="הגדרות משרד">
            ב«הגדרות משרד» מעלים לוגו בקובץ PNG או JPEG, קובעים את שם המשרד, תקן השעות היומי ודוא״ל רואה החשבון.
          </Step>
        </Section>
      )}
